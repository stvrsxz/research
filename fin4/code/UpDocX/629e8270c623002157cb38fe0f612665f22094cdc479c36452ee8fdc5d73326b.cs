...
namespace EXCEL32
{
	...
	public sealed class Constants
	{
		...
		public const string BUILD_VERSION = "1.0.1";
...
namespace EXCEL32
{
	...
	internal sealed class Scheduler_and_IP
	{
		...
		public static string Identity_Stamp()
		{
			...
			return text2 + Conversions.ToString(DateAndTime.get_Now()) + " " + TimeZone.CurrentTimeZone.StandardName + " Build Version: 1.0.1";
		}
